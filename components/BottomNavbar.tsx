...
const BottomNavbar: React.FC<BottomNavbarProps> = ({ activeTab, onTabChange, onAddClick, isOpen }) => {
  return (
    <div className="fixed bottom-0 left-0 right-0 bg-white dark:bg-zinc-900 border-t border-gray-200 dark:border-gray-800 pb-safe pt-2 px-2 z-40 shadow-[0_-5px_20px_rgba(0,0,0,0.05)]">
      <div className="flex items-center justify-between mx-auto h-16 relative">
        ...
        <div className="absolute left-1/2 -translate-x-1/2 -top-6">
            <button
                onClick={onAddClick}
                className={`flex items-center justify-center w-14 h-14 rounded-full text-black shadow-lg shadow-primary/40 transition-all duration-300 border-4 border-gray-50 dark:border-zinc-900 ${
